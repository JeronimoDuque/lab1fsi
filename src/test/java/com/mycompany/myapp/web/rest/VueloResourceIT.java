...
class VueloResourceIT {
    ...
    private static final Instant UPDATED_FECHA_SALIDA = Instant.ofEpochMilli(1790125853702L);

    private static final Instant DEFAULT_FECHA_LLEGADA = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_FECHA_LLEGADA = Instant.ofEpochMilli(1790125853702L);
